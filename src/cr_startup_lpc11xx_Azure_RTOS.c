...
//lpc1114
extern void __tx_NMIHandler(void);
extern void __tx_HardfaultHandler(void);
...
void (* const g_pfnVectors[])(void) = {
	...
	__tx_NMIHandler,                            // The NMI handler
	__tx_HardfaultHandler,                      // The hard fault handler
    0,                                      // Reserved
    0,                                      // Reserved
    0,                                      // Reserved
